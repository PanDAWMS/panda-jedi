...
class JediTaskBuffer(TaskBuffer.TaskBuffer, CommandReceiveInterface):
    ...
    def getTaskWithID_JEDI(self, jediTaskID, fullFlag=False, lockTask=False, pid=None, lockInterval=None,
        ...
        proxy = self.proxyPool.getProxy()
        # exec
        retVal = proxy.getTaskWithID_JEDI(jediTaskID, fullFlag, lockTask, pid, lockInterval, clearError)
        # release proxy
        self.proxyPool.putProxy(proxy)
        # return
        return retVal
    ...
    def getTaskWithJumbo_JEDI(self, vo, prodSourceLabel):
        ...
        proxy = self.proxyPool.getProxy()
        # exec
        retVal = proxy.getTaskWithJumbo_JEDI(vo, prodSourceLabel)
        # release proxy
        self.proxyPool.putProxy(proxy)
        # return
        return retVal
    ...
    def getTaskToEnableJumbo_JEDI(self, vo, prodSourceLabel, maxPrio, nEventsToEnable):
        ...
        proxy = self.proxyPool.getProxy()
        # exec
        retVal = proxy.getTaskToEnableJumbo_JEDI(vo, prodSourceLabel, maxPrio, nEventsToEnable)
        # release proxy
        self.proxyPool.putProxy(proxy)
        # return
        return retVal
    ...
    def kickPendingTasksWithJumbo_JEDI(self, jediTaskID):
        ...
        proxy = self.proxyPool.getProxy()
        # exec
        retVal = proxy.kickPendingTasksWithJumbo_JEDI(jediTaskID)
        # release proxy
        self.proxyPool.putProxy(proxy)
        # return
        return retVal
    ...
    def resetInputToReGenCoJumbo_JEDI(self, jediTaskID):
        ...
        proxy = self.proxyPool.getProxy()
        # exec
        retVal = proxy.resetInputToReGenCoJumbo_JEDI(jediTaskID)
        # release proxy
        self.proxyPool.putProxy(proxy)
        # return
        return retVal
